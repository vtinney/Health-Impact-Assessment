...
#ala_bb <- c(left = -122.3423, bottom = 37.45419, right = -121.5567, top = 37.90583)

map <- openmap(c(37.4,-122.4), c(37.95,-121.4),
               type = "esri-topo",
               mergeTiles = TRUE)
map.latlon <- openproj(map, projection = "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")

# Alameda NO2
setwd("/home/vtinney/AF/no2/ala/")
...
"Alameda County, CVD mortality and nitrogen dioxide, ages 65-99 years.",
"Alamada County, asthma incidence and nitrogen dioxide, ages 0-17 years.",
...
"Alameda County, CVD mortality and nitrogen dioxide, ages 65-99 years.",
"Alameda County, all-cause mortality and nitrogen dioxide, ages 65-99 years.",
"Alameda County, all-cause mortality and nitrogen dioxide, ages 65-99 years.", 
...
"Concentrations: Larkin et al. 2017. CRF: Atkinson et al. 2018.",
...
for (k in 1:length(files)){
  ...
  autoplot(map.latlon)  +
    ...
    labs(title=paste0(title$titles[k],sep=''),
         ...
         subtitle=paste0('Range: ',min.af.label,' to ',max.af.label,' %. Extent: -122.342, -121.469, 37.454, 37.906.'),sep='')
...
setwd("/home/vtinney/AF/pm/ala/")
list.files()

titles <- c("Alameda County, all-cause mortality and fine particulate matter, ages 25-99 years.",
...
captions <- c("Concentrations: Harvard dataset. CRF: Vodonos et al. 2015 parametric.",
"Concentrations: Harvard dataset. CRF: Thurston et al. 2016.",
"Concentrations: Harvard dataset. CRF: Lepuele et al. 2012.",
"Concentrations: Harvard dataset. CRF: Vodonos et al. 2015 continuous.",      
