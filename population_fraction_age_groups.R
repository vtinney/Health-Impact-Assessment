#VTinney 2019-2-19
# Step 1 - import rasters and clip to oakland extent using shapefile
# Step 2 - stack rasters and divide by population total GPW
...
gpw0_4 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a000_004bt_2010_cntm_30_sec.tif')
gpw5_9 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a005_009bt_2010_cntm_30_sec.tif')
gpw10_14 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a010_014bt_2010_cntm_30_sec.tif')
gpw15_19 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a015_019bt_2010_cntm_30_sec.tif')
gpw20_24 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a020_024bt_2010_cntm_30_sec.tif')
gpw25_29 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a025_029bt_2010_cntm_30_sec.tif')
gpw30_34 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a030_034bt_2010_cntm_30_sec.tif')
gpw35_39 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a035_039bt_2010_cntm_30_sec.tif')
gpw40_44 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a040_044bt_2010_cntm_30_sec.tif')
gpw45_49 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a045_049bt_2010_cntm_30_sec.tif')
gpw50_54 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a050_054bt_2010_cntm_30_sec.tif')
gpw55_59 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a055_059bt_2010_cntm_30_sec.tif')
gpw60_64 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a060_064bt_2010_cntm_30_sec.tif')
gpw65_69 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a065_069bt_2010_cntm_30_sec.tif')
gpw70_74 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a070_074bt_2010_cntm_30_sec.tif')
gpw75_79 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a075_079bt_2010_cntm_30_sec.tif')
gpw80_84 <- raster('CIESEN/full/gpw_v4_basic_demographic_characteristics_rev10_a080_084bt_2010_cntm_30_sec.tif')

#import GPW population total raster
poptot <- raster('overall/gpw_v4_population_count_rev10_2010_30_sec.tif')

#import shapefile of bay area extent
sp_df <- readOGR(dsn = "CIESEN", layer = "BS2")
...
writeRaster(all_my_rasts, filename="allages_pop_total.tif", format="GTiff", overwrite=TRUE)
writeRaster(pop_frac, filename='all_pop_frac.tif', format="GTiff", overwrite=TRUE)

#import LandScan raster
conus <- raster('pop/CONUS2017.tif')

#Resample such that LandScan and Population fraction are on the same resolution
resample_pop_frac <- resample(pop_frac, conus, method='bilinear')

#Multiple population fraction by the original population counts in LandScan
conus_pop_frac <- resample_pop_frac * conus
...
writeRaster(conus_pop_frac, filename="conus_age_pop_frac.tif", format="GTiff", overwrite=TRUE)