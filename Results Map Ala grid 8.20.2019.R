...
for (k in 1:length(files)){
  ...
  autoplot(map.latlon)  +
    ...
    labs(title=paste0(title$titles[k],sep=''),
         ...
         subtitle=paste0('Range: ',min.r.label,' to ',max.r.label,' per grid cell. Extent: -122.342, -121.469, 37.454, 37.906.'),sep='')
...
number of times the lowest risk",
    ...
    labs(title=paste0(title$titles[k],sep=''),
         caption=paste0(caption$captions[k],sep=''),
         subtitle=paste0('Range: ',min.er.label,' to ',max.er.label,' per grid cell. Extent: -122.342, -121.469, 37.454, 37.906.'),sep='')
